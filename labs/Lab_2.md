...
The `--exit` flag is used to [shutdown the application](../src/main/java/com/ibm/code/java/App.java#L32) as soon as it has finished start-ing up so we don't hang in an interactive shell. This allows us to repeatedly call the application
